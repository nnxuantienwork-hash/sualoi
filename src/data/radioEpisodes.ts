...
const generateThumbnail = (seed: string, category: string): string => {
  const gradients: { [key: string]: string } = {
    'Thời Sự': 'linear-gradient(135deg, #1E3A8A 0%, #3B82F6 100%)',
    'Kinh Tế': 'linear-gradient(135deg, #047857 0%, #10B981 100%)',
    'Văn Hóa': 'linear-gradient(135deg, #7C3AED 0%, #A78BFA 100%)',
    'Giải Trí': 'linear-gradient(135deg, #DB2777 0%, #F472B6 100%)',
    'Thể Thao': 'linear-gradient(135deg, #DC2626 0%, #F87171 100%)',
    'Sức Khỏe': 'linear-gradient(135deg, #059669 0%, #34D399 100%)',
  };
...
export const radioEpisodes: RadioEpisode[] = [
  {
    ...
    thumbnail: generateThumbnail('metro-news', 'Thời Sự'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('digital-economy', 'Kinh Tế'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('indie-music', 'Văn Hóa'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('sleep-health', 'Sức Khỏe'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('ai-revolution', 'Thời Sự'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('sea-games', 'Thể Thao'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('vietnam-cinema', 'Giải Trí'),
  ...
  },
  {
    ...
    thumbnail: generateThumbnail('startup-stories', 'Kinh Tế'),
